...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<hoe-git>.freeze, ["~> 1.6.0"])
      ...
      s.add_development_dependency(%q<concourse>.freeze, ["~> 0.11"])
      s.add_development_dependency(%q<rdoc>.freeze, ["~> 4.0"])
      s.add_development_dependency(%q<hoe>.freeze, ["~> 3.16"])
    else
      s.add_dependency(%q<mini_portile2>.freeze, ["~> 2.2.0"])
      s.add_dependency(%q<hoe-bundler>.freeze, ["~> 1.2.0"])
      s.add_dependency(%q<hoe-debugging>.freeze, ["~> 1.3.0"])
      s.add_dependency(%q<hoe-gemspec>.freeze, ["~> 1.0.0"])
      s.add_dependency(%q<hoe-git>.freeze, ["~> 1.6.0"])
      ...
      s.add_dependency(%q<concourse>.freeze, ["~> 0.11"])
